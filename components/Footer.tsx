...
const footerLinks = {
  ...
  Commands: [
    ...
    { label: "cxgrd input", href: "https://docs.cxgrd.com/commands/input" },
    { label: "cxgrd prompt", href: "https://docs.cxgrd.com/commands/prompt" },
    { label: "cxgrd auth login", href: "https://docs.cxgrd.com/commands/auth-login" },
    { label: "cxgrd doctor", href: "https://docs.cxgrd.com/commands/doctor" },
    { label: "cxgrd init-hooks", href: "https://docs.cxgrd.com/commands/init-hooks" },
    { label: "cxgrd watch", href: "https://docs.cxgrd.com/commands/watch" },
    { label: "cxgrd check", href: "https://docs.cxgrd.com/commands/check" },
  ],
  Resources: [
    { label: "Documentation", href: "https://docs.cxgrd.com" },
