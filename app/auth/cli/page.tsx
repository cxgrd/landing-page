...
export default function CLIAuthPage() {
  ...
  const handleGitHubAuth = () => {
    setIsLoading(true);
    // In production, this would initiate GitHub OAuth via Supabase
    // For now, redirect to auth/github with session parameter
    window.location.href = `/auth/github?session=${sessionId}`;
  };
          ...
          <div className="glass-surface rounded-2xl p-10">
            ...
            <div className="mt-8 space-y-3 rounded-xl border border-blue-500/20 bg-blue-500/10 p-4">
              ...
              <ol className="space-y-2 text-xs text-slate-300">
                ...
                <li>3. Return to your CLI to continue</li>
                <li>4. Your Pro features are now unlocked</li>
              </ol>
            </div>
